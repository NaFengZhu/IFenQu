...
public final class SettingUtil {
	...
	/**
	 * 根据build type 自动化配置服务器地址
	 */
	public static final String URL_SERVER_ADDRESS_NORMAL_HTTPS = BuildConfig.BASE_URL;
	...
	public static String getCurrentServerAddress(boolean isHttps) {
		return isHttps ? URL_SERVER_ADDRESS_NORMAL_HTTPS:"目前都是以https执行网络请求";
	}
